...
TerrakionTrainerHeader:
	dbEventFlagBit EVENT_BEAT_TERRAKION, 1
	db 0 ; view range
	dwEventFlagAddress EVENT_BEAT_TERRAKION, 1
	dw TerrakionBattleText ; TextBeforeBattle
	dw TerrakionBattleText ; TextAfterBattle
	dw TerrakionBattleText ; TextEndBattle
	dw TerrakionBattleText ; TextEndBattle
